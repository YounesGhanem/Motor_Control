...
/**
  ...
  */
__weak bool ENC_CalcAvrgMecSpeedUnit(HALL_Handle_t *pHandle, int16_t *pMecSpeedUnit)
{
  bool bReliability;
#ifdef NULL_PTR_CHECK_ENC_SPD_POS_FDB
...
/**
  ...
  */
__weak void ENC_SetMecAngle(HALL_Handle_t *pHandle, int16_t hMecAngle)
{
#ifdef NULL_PTR_CHECK_ENC_SPD_POS_FDB
  if (NULL == pHandle)
  {
